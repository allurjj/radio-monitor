...
- **Radio Scraping:** Monitors 28 radio stations using requests + BeautifulSoup
...
- **Requests 2.x** - HTTP client for web scraping
...
|--------|---------|-------------------|
| `scrapers.py` | Radio scraping | requests + BeautifulSoup |
...
APScheduler (BackgroundScheduler)
    ...
    │       │
    │       ▼
    │   scrapers.py ─► requests ─► Station Websites
    │       │
    │       ▼
...
└──────────────┬───────────────────────────────┘
               ...
               ▼
┌──────────────────────────────────────────────┐
│    requests: Fetch station website          │
