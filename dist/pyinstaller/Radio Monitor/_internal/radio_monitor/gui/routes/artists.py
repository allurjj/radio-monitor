...
def artists_list():
    ...
    valid_columns = ['name', 'song_count', 'total_plays', 'last_seen', 'first_seen', 'validated_count', 'verified_count', 'status']
...
def api_update_artist_mbid():
    ...
    try:
        ...
        if existing_new_artist:
            ...
            # Disable foreign key constraints to allow updating songs
