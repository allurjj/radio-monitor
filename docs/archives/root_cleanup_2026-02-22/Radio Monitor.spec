...
a = Analysis(
    ...
    hiddenimports=['flask', 'werkzeug', 'jinja2', 'markupsafe', 'itsdangerous', 'click', 'apscheduler', 'apscheduler.schedulers.background', 'apscheduler.triggers.cron', 'beautifulsoup4', 'plexapi', 'plexapi.server', 'plexapi.base', 'pkg_resources', 'requests', 'urllib3'],
    hookspath=[],
    hooksconfig={},
    runtime_hooks=[],
