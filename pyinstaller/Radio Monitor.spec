...
a = Analysis(
    ...
    hiddenimports=['sqlite3', 'flask', 'flask_httpauth', 'bcrypt', '_bcrypt', 'werkzeug', 'jinja2', 'markupsafe', 'itsdangerous', 'click', 'apscheduler', 'apscheduler.schedulers.background', 'apscheduler.triggers.cron', 'bs4', 'plexapi', 'plexapi.server', 'plexapi.base', 'pkg_resources', 'requests', 'urllib3', 'musicbrainzngs', 'rapidfuzz', 'rapidfuzz.fuzz', 'rapidfuzz.process', 'rapidfuzz.utils', 'email', 'email.mime', 'email.mime.text', 'email.mime.multipart', 'jinja2', 'markupsafe', 'itsdangerous', 'click', 'apscheduler', 'apscheduler.schedulers.background', 'apscheduler.triggers.cron', 'bs4', 'plexapi', 'plexapi.server', 'plexapi.base', 'pkg_resources', 'requests', 'urllib3'],
    hookspath=[],
    hooksconfig={},
