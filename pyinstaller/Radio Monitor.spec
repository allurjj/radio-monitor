...
a = Analysis(
    ...
    hiddenimports=['sqlite3', 'flask', 'flask_httpauth', 'bcrypt', '_bcrypt', 'werkzeug', 'jinja2', 'markupsafe', 'itsdangerous', 'click', 'apscheduler', 'apscheduler.schedulers.background', 'apscheduler.triggers.cron', 'bs4', 'plexapi', 'plexapi.server', 'plexapi.base', 'pkg_resources', 'requests', 'urllib3', 'musicbrainzngs', 'rapidfuzz', 'rapidfuzz.fuzz', 'rapidfuzz.process', 'rapidfuzz.utils', 'yt_dlp', 'mutagen', 'mutagen.id3', 'mutagen.flac', 'Crypto', 'Crypto.Cipher', 'spotipy', 'spotipy.oauth2', 'email', 'email.mime', 'email.mime.text', 'email.mime.multipart', 'jinja2', 'markupsafe', 'itsdangerous', 'click', 'apscheduler', 'apscheduler.schedulers.background', 'apscheduler.triggers.cron', 'bs4', 'plexapi', 'plexapi.server', 'plexapi.base', 'pkg_resources', 'requests', 'urllib3'],
    hookspath=[],
    hooksconfig={},
